        ...
        <div class="w-full max-w-2xl mx-auto">
            ...
            <form class="bg-white shadow-md rounded px-8 pt-6 pb-8" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="datum_oddaje" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
                <div class="mb-6">
